...
def PlotData(data_true, ax=None, style ='', lab='True'):
    # Changed to match data EMforward_2lay format
    if ax.any() == None:
        fig, ax = plt.subplots(3,2, sharex=True,)
    
    ax[0,0].plot(data_true[:,0]*1e3, 'b'+style, label = 'H2 '+lab, markersize=4)
    ax[0,0].plot(data_true[:,3]*1e3, 'g'+style, label = 'V2 '+lab, markersize=4)
    ax[0,0].plot(data_true[:,6]*1e3, 'r'+style, label = 'P2.1 '+lab, markersize=4)
    ax[0,0].tick_params(labelsize=5)
    ax[0,0].set_ylabel('Q [ppt]', fontsize=5)

    ax[1,0].plot(data_true[:,1]*1e3, 'b'+style, label = 'H4 '+lab, markersize=4)
    ax[1,0].plot(data_true[:,4]*1e3, 'g'+style, label = 'V4 '+lab, markersize=4)
    ax[1,0].plot(data_true[:,7]*1e3, 'r'+style, label = 'P4.1 '+lab, markersize=4)
    ax[1,0].tick_params(labelsize=5)
    ax[1,0].set_ylabel('Q [ppt]', fontsize=5)

    ax[2,0].plot(data_true[:,2]*1e3, 'b'+style, label = 'H8 '+lab, markersize=4)
    ax[2,0].plot(data_true[:,5]*1e3, 'g'+style, label = 'V8 '+lab, markersize=4)
    ax[2,0].plot(data_true[:,8]*1e3, 'r'+style, label = 'P8.1 '+lab, markersize=4)
    ax[2,0].tick_params(labelsize=5)
    ax[2,0].set_xlabel('Horizontal distance [m]', fontsize=5)
    ax[2,0].set_ylabel('Q [ppt]', fontsize=5)

    ax[0,1].plot(data_true[:,9]*1e3, 'b'+style, label = 'H2 '+lab, markersize=4)
    ax[0,1].plot(data_true[:,12]*1e3, 'g'+style, label = 'V2 '+lab, markersize=4)
    ax[0,1].plot(data_true[:,15]*1e3, 'r'+style, label = 'P2.1 '+lab, markersize=4)
    ax[0,1].tick_params(labelsize=5)
    ax[0,1].set_ylabel('IP [ppt]', fontsize=5)

    ax[1,1].plot(data_true[:,10]*1e3, 'b'+style, label = 'H '+lab, markersize=4)
    ax[1,1].plot(data_true[:,13]*1e3, 'g'+style, label = 'V '+lab, markersize=4)
    ax[1,1].plot(data_true[:,16]*1e3, 'r'+style, label = 'P '+lab, markersize=4)
    ax[1,1].tick_params(labelsize=5)
    ax[1,1].set_ylabel('IP [ppt]', fontsize=5)

    ax[2,1].plot(data_true[:,11]*1e3, 'b'+style, label = 'H8 '+lab, markersize=4)
    ax[2,1].plot(data_true[:,14]*1e3, 'g'+style, label = 'V8 '+lab, markersize=4)
    ax[2,1].plot(data_true[:,17]*1e3, 'r'+style, label = 'P8.1 '+lab, markersize=4)
    ax[2,1].set_ylabel('IP [ppt]', fontsize=5)
    ax[2,1].set_xlabel('Horizontal distance [m]', fontsize=5)
    ax[2,1].tick_params(labelsize=5)

    #ax[0,1].legend(bbox_to_anchor=(1.2, 1.0), loc='upper left', fontsize=7)
    ax[1,1].legend(bbox_to_anchor=(1.1, 1.0), loc='upper left',fontsize=5)
    #ax[2,1].legend(bbox_to_anchor=(1.2, 1.0), loc='upper left',fontsize=7)
